...
<head>
    ...
    <title>BusTicket - Connexion</title>
...
<body class="font-sans antialiased">
        ...
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-center md:justify-between items-center">
                ...
                <div class="flex gap-3">
                    ...
                    <a href="{{ route('register') }}" class="btn-outline px-5 py-2 rounded-xl text-white font-medium text-sm">
    ...
    <div class="min-h-screen flex items-center justify-center p-4 pt-24">
        <div class="w-full max-w-md">
            ...
            <div class="login-container rounded-3xl p-8 shadow-2xl">
                <!-- Session Status -->
                @if (session('status'))
                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="flex items-center justify-between mb-6">
                        <label class="flex items-center cursor-pointer">
                            <input type="checkbox" name="remember" class="rounded border-white/20 bg-slate-800 text-orange-500 focus:ring-orange-500">
                            <span class="ml-2 text-sm text-slate-400">Se souvenir de moi</span>
                        </label>
                        @if (Route::has('password.request'))
                            <a href="{{ route('password.request') }}" class="text-sm text-orange-400 hover:text-orange-300 transition">
                                Mot de passe oublié ?
                            </a>
                        @endif
                    </div>

                    <button type="submit" class="btn-login w-full py-3 rounded-xl text-white font-semibold text-lg transition flex items-center justify-center gap-2">
                ...
                <p class="text-center text-slate-400 text-sm mt-6">
                    ...
                    <a href="{{ route('register') }}" class="text-orange-400 hover:text-orange-300 font-semibold transition">
                        Créer un compte
                    </a>
                </p>
            </div>
