...
<head>
    ...
    <title>BusTicket - Mot de passe oublié</title>
    ...
    <div class="min-h-screen flex items-center justify-center p-4 pt-24">
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-400">Entrez votre email pour recevoir un lien</p>
            </div>

            <!-- Formulaire centré -->
            <div class="forgot-container rounded-3xl p-8 shadow-2xl">
                <!-- Texte d'information -->
                <div class="mb-6 p-3 rounded-xl bg-blue-500/10 border border-blue-500/30 text-blue-400 text-center text-sm">
                ...
                <form method="POST" action="{{ route('password.email') }}">
                    ...
                    <button type="submit" class="btn-submit w-full py-3 rounded-xl text-white font-semibold text-lg transition flex items-center justify-center gap-2">
                ...
                <div class="text-center mt-6">
                    <a href="{{ route('login') }}" class="text-orange-400 hover:text-orange-300 transition inline-flex items-center gap-2">
